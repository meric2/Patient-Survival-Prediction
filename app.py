...
This app predicts if you are healthy or in danger by means of your blood test.
...
uploaded_file = st.sidebar.file_uploader("Upload your health report in a CSV file in the format of the example above.", type=["csv"])
...
if prediction == 1:
    st.write("**Mortality**")
    st.write("It is suggested that you should get checked.")
